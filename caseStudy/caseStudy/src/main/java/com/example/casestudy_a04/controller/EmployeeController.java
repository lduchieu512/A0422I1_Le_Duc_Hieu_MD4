...
public class EmployeeController {
    ...
    @PostMapping("/create")
    public String doCreate(@Valid @ModelAttribute("employee") Employee employee, BindingResult bindingResult ,
    ...
    @PostMapping("/edit")
    public String doEdit(@Valid @ModelAttribute("employee") Employee employee, BindingResult bindingResult ,
                           Model model, RedirectAttributes redirectAttributes){
        if(bindingResult.hasErrors()){
            employee.setPositionId(new Position());
            employee.setEducationDegreeId(new EducationDegree());
