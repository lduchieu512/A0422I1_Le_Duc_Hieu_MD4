...
public class ProvinceController {
    ...
    public ModelAndView saveProvince(@ModelAttribute("province") Province province)throws Exception {
    ...
    public ModelAndView updateProvince(@ModelAttribute("province") Province province) throws Exception{
        provinceService.save(province);
        ModelAndView modelAndView = new ModelAndView("/province/edit");
    ...
    public String deleteProvince(@ModelAttribute("province") Province province)throws Exception {
